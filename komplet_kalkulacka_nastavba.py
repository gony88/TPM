...
n_motor_start = 1100.0  # [rpm] Otáčky motoru na začátku pohybu vozidla
n_motor_end   = 1100.0  # [rpm] Otáčky motoru na konci prokluzu (synchronizace)
n_motor_idle  = 1100.0   # [rpm] Otáčky motoru v PAUZE (volnoběh)
...
n_slip_start  = 1100.0  # [rpm] Počáteční prokluz (rozdíl rychlostí)
n_slip_end    = 0.0     # [rpm] Konec prokluzu (vždy 0)

# --- F. ČASOVÁNÍ CYKLU ---
n_cyklu = 1           # Počet opakování rozjezdu
t_zab   = 10        # [s] Doba trvání dynamického prokluzu (samotný rozjezd)
t_pauza = 1         # [s] Doba chladnutí mezi rozjezdy
